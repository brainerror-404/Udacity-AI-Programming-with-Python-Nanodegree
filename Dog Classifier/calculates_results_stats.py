...
def calculates_results_stats(results_dic):
    ...
    # this function
    # Create an empty dictionary for results statistics
    ...
    for key in results_dic:
        ...
        # Check if the pet labels is a dog and the labels match
        ...
        # Pet label and classifier label are not a dog
        else:
    ...
    # Calculate number of images that are not a dog
    ...
    # Calculate the percentage of correctly classified not a dog
