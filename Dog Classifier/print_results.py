...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # Print statistics summary (percentage) on Model Run
    print("\nStatistics Summary on Model Run: ")
    # Only print out key and value where the key starts with p
    ...
    if (print_incorrect_dogs and ((results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'])
        ...
        for key in results_dic:
            # Pet label is a dog but classifier label is not a dog and vice versa
    ...
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        ...
        for key in results_dic:
            # Both pet and classifier labels are a dog but it is the wrong breed
